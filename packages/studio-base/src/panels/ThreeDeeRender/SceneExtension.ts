...
> extends THREE.Object3D<E> {
   ...
   */
  public updateSettingsTree(write?: "immediate" | "debounced"): void {
    this._settingsUpdateDebounced();
    if (write === "immediate") {
      this._settingsUpdateDebounced.flush();
    }
  }
  ...
  public saveSetting(
    path: Path,
    value: unknown,
    write: "immediate" | "debounced" = "immediate",
  ): void {
